...
from pro_file_organizer.ui.dialogs import settings_dialog_ctk as settings_dialog
...
class TestSettingsDialog(unittest.TestCase):
    ...
    def test_add_category_empty(self):
        ...
        with patch('pro_file_organizer.ui.dialogs.settings_dialog_ctk.messagebox.showerror') as mock_error:
            dialog.add_category()
    ...
    def test_export_profile(self):
        ...
        with patch('pro_file_organizer.ui.dialogs.settings_dialog_ctk.filedialog.asksaveasfilename', return_value="test_profile.json"):
            with patch.object(self.organizer, 'export_config_file', return_value=True) as mock_export:
                with patch('pro_file_organizer.ui.dialogs.settings_dialog_ctk.messagebox.showinfo') as mock_info:
    ...
    def test_import_profile(self):
        ...
        with patch('pro_file_organizer.ui.dialogs.settings_dialog_ctk.filedialog.askopenfilename', return_value="test_profile.json"):
            with patch('pro_file_organizer.ui.dialogs.settings_dialog_ctk.messagebox.askyesno', return_value=True):
